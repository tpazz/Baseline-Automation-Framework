...
public class FireFoxDriverProperties implements DriverSource {
    ...
    public WebDriver newDriver() {
        ...
        try { FireFoxDriverSetup.main("Mac", firefoxOptions); }
        catch (Exception e) { e.printStackTrace(); }
        System.setProperty("webdriver.gecko.driver", "src/test/resources/webdriver/linux/geckodriver-macx64/geckodriver");
