...
public class ChromeDriverProperties implements DriverSource {
    ...
    public WebDriver newDriver() {
        ...
        try { ChromeDriverSetup.main("Mac", chromeOptions); }
        catch (Exception e) { e.printStackTrace(); }
        System.setProperty("webdriver.chrome.driver", "src/test/resources/webdriver/mac/chromedriver-mac-x64/chromedriver");
